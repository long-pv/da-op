            ...
            <div class="row">
                ...
                <div class="col-md-5 col-sm-6 col-xs-12">
                    <div class="footer-links">
                        ...
                        <?php if (!empty($column_2['map'])) : ?>
                            <div class="map-responsive"><?php echo $column_2['map'] ?></div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="col-md-3 col-sm-12 col-xs-12">
                    <div class="footer-subscribe">
                        ...
                        <?php endif; ?>
                        <?php if (!empty($column_4['short_code_form'])) : ?>
                            <?php echo do_shortcode($column_4['short_code_form']); ?>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
